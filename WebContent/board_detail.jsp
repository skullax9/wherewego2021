...
<body>
  ...
  String userID = null;
	...
	<script>
      function button_check() {
         if (confirm("정말 삭제하시겠습니까??") == true){
            location.href="board_delete.jsp?postID="+<%=num%>;
         } else {
            return;
         }
      };
   ...
   sql = "select postID, postTITLE, userID ,postCONTENT from BOARD where postID = "+num;
   ...
   %>
     ...
     <div id="warp" style="margin-top:30px"> 
       ...
       <div class="container" style="margin-top:30px;">
         <table class="table" style="text-align: center;">
            ...
            <div class="dropdown" style="margin-bottom: 60px">
                ...
                <a class="dropdown-item" href="board.jsp">뒤로가기</a>
                <% 
                   rs.close();
					if (userID == null){
                		
                	}
               		else if ((userID.equals(uID)) || (userID.equals("admin"))){%>
                   <a class="dropdown-item" href="board_modify.jsp?postID=<%=pid%>">수정하기</a>
      ...
      <%
      sql = "select count(*) from REPLY where bno="+num;
      rs = st.executeQuery(sql);
      ...
      <%
    	  ...
    	  String listSQL = "SELECT replytext, replyer, regdate FROM `REPLY` where bno ="+num+" order by replyid;";
     ...
     <div class="write-comment" style="margin-left: 95px;">
            <form action="board_comment.jsp?postID=<%=num %>" class="write-comment1-1" method="post">
