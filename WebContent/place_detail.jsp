...
<body>
    ...
    <%
   String lo = (String)request.getParameter("location"); // 클릭한 여행지명을 받아온다
   ...
   sql = "select * from SEASON where location = '"+lo+"';";
   ...
   %>
    ...
    <div id="warp">
    <!-- 클릭한 여행지의 태그 값에 따라 출력되는 계절명 변경 -->
    <%if (tag.equals("spring")){%>
      <div class="main-box-name"><%=spring %></div>
    <%} else if (tag.equals("summer")) {%>
    <div class="main-box-name"><%=summer %></div>
    <%} else if (tag.equals("fall")) {%>
    <div class="main-box-name"><%=autumn %></div>
    <%} else {%>
    <div class="main-box-name"><%=winter %></div>
    <%} %>
            ...
            <div class="product_top">
                ...
                <div class="product_info">
                    <div class="product_info_box">
                        ...
                        <div style="height:238.8px; width: 545px;"> <!-- 시작  -->
                            <p>설명</p>   <!-- 제목 -->
                            <span class="product_info-span"> <!-- 설명 span태그 추가하면 아래로 내려감 -->
